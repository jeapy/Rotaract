...
use JP\ProfilBundle\Entity\Club;
...
class ClubController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clubs = $em->getRepository('JPProfilBundle:Club')->findAll();
    ...
    {
        $club = new Club();
        $form = $this->createForm('JP\ProfilBundle\Form\ClubType', $club);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('profil_member_club_show', array('id' => $club->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($club);
        $editForm = $this->createForm('JP\ProfilBundle\Form\ClubType', $club);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('profil_member_club_edit', array('id' => $club->getId()));
        }
    ...
    public function deleteAction(Request $request, Club $club)
    {
        ...
        return $this->redirectToRoute('profil_member_club_index');
    }
    ...
    private function createDeleteForm(Club $club)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('profil_member_club_delete', array('id' => $club->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
